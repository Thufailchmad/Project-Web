...
<div class="col-md-6 side-image">
    <img src="../assets-frontend/images/img-listrik.png" class="img-fluid" alt="register-image" width="60%" height="60%">
</div>
...
<div class="col-md-6">
    <div class="card custom-card">
        ...
        <div class="card-body">
            ...
            <?php if ($registered) { echo "<div class='alert alert-warning'>Email telah terdaftar</div>"; } ?>
        </div>
    </div>
</div>
